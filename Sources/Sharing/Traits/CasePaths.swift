  ...
  extension Shared {
    ...
    where Value: CasePathable {
      func open(_ reference: some MutableReference<Value>) -> Shared<Member?> {
        Shared<Member?>(
          reference: _MutableReferenceEnumToOptionalCase(
  ...
  extension SharedReader {
    ...
    where Value: CasePathable {
      func open(_ reference: some Reference<Value>) -> SharedReader<Member?> {
        SharedReader<Member?>(
          reference: _ReferenceEnumToOptionalCase(
            base: reference, keyPath: keyPath.unsafeSendable())
        )
      }
  ...
  extension _MutableReferenceEnumToOptionalCase: MutableReference {
    ...
    static func == (
      lhs: _MutableReferenceEnumToOptionalCase, rhs: _MutableReferenceEnumToOptionalCase
    ) -> Bool {
